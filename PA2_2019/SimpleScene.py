...
def display():
    global cameraIndex, cow2wld , cowCount, cow2wldList, cowLocationList, currentCowLocation ,cursorOnCowBoundingBox, C_ROM, animStartTime, isDrag, H_Drag, V_Drag
    #print(cow2wld)
...
def main():
    ...
    width = 800;
    height = 600;
    window = glfw.create_window(width, height, 'RedBull Roller Coaster - YangSangheon', None, None)
    if not window:
        glfw.terminate()
        sys.exit(-1)
