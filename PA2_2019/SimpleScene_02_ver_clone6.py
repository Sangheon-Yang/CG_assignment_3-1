...
def display():
    global cameraIndex, cow2wld , cowCount, cow2wldList, cowLocationList, currentCowLocation ,cursorOnCowBoundingBox
    ...
    if button == glfw.MOUSE_BUTTON_LEFT:
        ...
        # start vertical dragging
            ...
            if isDrag==V_DRAG and cursorOnCowBoundingBox :
                if cowCount<6:
                    cowCount +=1;
                    cow2wldList.append(cow2wld)
                    cowLocationList.append(currentCowLocation)
